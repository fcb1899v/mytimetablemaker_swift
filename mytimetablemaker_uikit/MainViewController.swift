...
// MARK: - Protocols
// Protocol for calculation functionality
protocol Calculation {
    var goorback: String { get }
    var weekflag: Bool { get }
}

// Protocol for display functionality
protocol Display {
...
// Main view controller for the application with Google Ad integration
class MainViewController: UIViewController, GADBannerViewDelegate {

    // MARK: - Timer and State Properties
    ...
    // MARK: - Layout Views
    // Stack views for layout management
    @IBOutlet weak var display2stackview: UIStackView!
    @IBOutlet weak var centerlineview: UIView!
    
    // MARK: - Station Labels (Route 1/2)
    // Labels for station information
    ...
    // MARK: - Line Labels (Route 1/2)
    // Labels for line information
    ...
    // MARK: - Line Timetable Views (Route 1/2)
    // Stack views for line timetables
    ...
    // MARK: - Transit Time Labels (Route 1/2)
    // Stack views for transit time information
    ...
    // MARK: - Transport Labels (Route 1/2)
    // Labels for transportation information
    ...
    // MARK: - Line Stack Views
    // Stack views for line segments
    ...
    // MARK: - Countdown and Time Labels
    // Labels for countdown and time display
    ...
    // MARK: - Google Ad Banner
    // Google Ad banner view
    @IBOutlet var bannerView: GADBannerView!

    // MARK: - Array Properties
    // Arrays to hold UI elements for easy access
    ...
    override func viewDidLoad() {
        ...
        // MARK: - Google Ad Integration
        // Initialize and configure Google Ad banner
        bannerView = GADBannerView(adSize: kGADAdSizeSmartBannerPortrait)
        addBannerViewToView(bannerView)
        bannerView.adUnitID = Config.adMobBannerUnitID
        ...
        timer = Timer.scheduledTimer(withTimeInterval: 0.1, repeats: true, block: {
            ...
            // Initialize arrays with UI elements
            ...
            // MARK: - Various Displays
            // Configure various display elements
            ...
            // MARK: - Route 2 Display/Hide
            // Show/hide route 2 based on switch flag
            ...
            // Calculate times: possible time[0], departure time[1], arrival time[2] and departure time
    ...
    // Handles back route display button
    ...
    // Handles go route display button
    ...
    // MARK: - Stop Timer Action
    // Handles stop timer button
    ...
    // MARK: - Line Label Actions (11-23)
    // Actions for line label buttons
    ...
    // MARK: - Line Timetable Actions (11-23)
    // Actions for line timetable buttons
    ...
    // MARK: - Transport Label Actions (11-2e)
    // Actions for transport label buttons
    ...
    // MARK: - Transit Time Label Actions (11-2e)
    // Actions for transit time label buttons
